...
func (c *frontendServiceClient) SearchHotels(ctx context.Context, in *SearchHotelsRequest, opts ...grpc.CallOption) (*SearchHotelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hotelproto.FrontendService/SearchHotels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *frontendServiceClient) StoreHotel(ctx context.Context, in *StoreHotelRequest, opts ...grpc.CallOption) (*StoreHotelResponse, error) {
	out := new(StoreHotelResponse)
	err := c.cc.Invoke(ctx, "/hotelproto.FrontendService/StoreHotel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *frontendServiceClient) FrontendReservation(ctx context.Context, in *FrontendReservationRequest, opts ...grpc.CallOption) (*FrontendReservationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hotelproto.FrontendService/FrontendReservation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFrontendServiceServer) StoreHotel(context.Context, *StoreHotelRequest) (*StoreHotelResponse, error) {
...
func _FrontendService_SearchHotels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hotelproto.FrontendService/SearchHotels",
	}
...
func _FrontendService_StoreHotel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StoreHotelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FrontendServiceServer).StoreHotel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hotelproto.FrontendService/StoreHotel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FrontendServiceServer).StoreHotel(ctx, req.(*StoreHotelRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _FrontendService_FrontendReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hotelproto.FrontendService/FrontendReservation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var FrontendService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hotelproto.FrontendService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FrontendService_StoreHotel_Handler,
		},
		{
